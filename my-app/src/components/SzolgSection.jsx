...
const SzolgSection = () => {
    return (
        <Container maxW='container.lg' display='flex' flexDirection='column' justifyContent='center'>
           <MotionInView variant="zoom-up"> <Flex mb={5} justifyContent='center'>
                <Text textAlign='center'  fontWeight='900' fontSize={{ base: '2xl', md: '4xl' }}>IDŐSEK GONDOZÁSA</Text>
            </Flex></MotionInView>
            ...
            >
                ...
                <MotionInView variant="fade-right">
                <Stack
                    spacing='4'
                    w="250px"
                    h='320px'
                ...
                >
                    ...
                    <Text fontFamily='Montserrat, Sans-serif' fontSize='xl' textTransform='uppercase' fontWeight='bold' textAlign='center' lineHeight='normal'>Rendszeres <br /> orvosi ellenőrzés</Text>
               ...
               <MotionInView variant="fade-left">
                <Stack
                    spacing='4'
                    w="300px"
                    h='320px'
                ...
                >
                    ...
                    <Text fontSize='xl' textAlign='center' fontFamily='Montserrat, Sans-serif' textTransform='uppercase' fontWeight='bold' lineHeight='normal'>Napi ötszöri étkezés, <br /> diétás lehetőséggel</Text>
