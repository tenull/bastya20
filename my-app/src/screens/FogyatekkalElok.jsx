            ...
            >
              <Stack spacing={4}>
                ...
                <Text color="gray.700" lineHeight="1.8" fontSize={{ base: "md", md: "lg" }}>
                  A Bástya Református Szociális Szolgáltató Központ fogyatékossággal élő személyek
                  nappali ellátását biztosító szolgáltatásának célja a hátrányos helyzetű célcsoportok
                  elérése, támogatása, valamint a szociális és egészségügyi ellátórendszerbe való
          ...
          <SimpleGrid columns={{ base: 1, md: 2 }} spacing={6} mt={8}>
            <MotionInView y={10}>
              <Box bg="white" rounded="2xl" borderWidth="1px" borderColor="gray.200" p={6} boxShadow="sm">
                <Heading fontSize="lg" fontWeight="900" mb={3}>
                  Kinek szól az ellátás?
                </Heading>
                <List spacing={2} color="gray.700" lineHeight="1.8">
                  <ListItem>
                    • Saját otthonukban élő, harmadik életévüket betöltött fogyatékos vagy autista személyeknek.
                  </ListItem>
                  <ListItem>
                    • Akik önkiszolgálásra részben képesek vagy nem képesek.
                  </ListItem>
                  <ListItem>
                    • Akik felügyeletre, támogatásra szorulnak napközben.
                  </ListItem>
                  <ListItem>
                    • Akik számára fontos a társas kapcsolatok fenntartása és a biztonságos közeg.
                  </ListItem>
                </List>
              </Box>
            </MotionInView>
            ...
            <MotionInView y={10} delay={0.05}>
              <Box bg="white" rounded="2xl" borderWidth="1px" borderColor="gray.200" p={6} boxShadow="sm">
                ...
                <List spacing={2} color="gray.700" lineHeight="1.8">
                  <ListItem>• Napközbeni tartózkodást és felügyeletet.</ListItem>
                  <ListItem>• Étkezést és alapvető higiénés szükségletek kielégítését.</ListItem>
                  <ListItem>• Társas kapcsolatokat, közösségi jelenlétet.</ListItem>
                  <ListItem>• Az egyéni állapothoz igazodó támogatást.</ListItem>
                </List>
              </Box>
            </MotionInView>
          </SimpleGrid>
          <MotionInView y={10}>
            ...
            >
              ...
              <Text color="gray.700" lineHeight="1.8">
                Az ellátottak képességeihez, igényeihez és lehetőségeihez igazodva biztosítjuk
                a gondozást, fejlesztést és foglalkozásokat. Munkánkkal elősegítjük a közösséghez
                tartozás élményét, erősítjük az önállóságot és hozzájárulunk a magasabb életminőség
                kialakításához.
              </Text>
            </Box>
          </MotionInView>
...
export default FogyatekkalElok;
